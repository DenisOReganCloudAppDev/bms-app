...
class ManagersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manager" do
    assert_difference("Manager.count") do
      post managers_url, params: { manager: { building_id: @manager.building_id, email: @manager.email, first_name: @manager.first_name, last_name: @manager.last_name, phone: @manager.phone } }
    end
  ...
  test "should update manager" do
    patch manager_url(@manager), params: { manager: { building_id: @manager.building_id, email: @manager.email, first_name: @manager.first_name, last_name: @manager.last_name, phone: @manager.phone } }
