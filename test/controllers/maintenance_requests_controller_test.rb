...
class MaintenanceRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create maintenance_request" do
    assert_difference("MaintenanceRequest.count") do
      post maintenance_requests_url, params: { maintenance_request: { comment: @maintenance_request.comment, completed: @maintenance_request.completed, requestDate: @maintenance_request.requestDate, requestinfo: @maintenance_request.requestinfo, tenant_id: @maintenance_request.tenant_id } }
    end
  ...
  test "should update maintenance_request" do
    patch maintenance_request_url(@maintenance_request), params: { maintenance_request: { comment: @maintenance_request.comment, completed: @maintenance_request.completed, requestDate: @maintenance_request.requestDate, requestinfo: @maintenance_request.requestinfo, tenant_id: @maintenance_request.tenant_id } }
